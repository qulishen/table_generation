...
def parse_args():
    ...
    # row and col
    parser.add_argument('--min_row', type=int, default=16, help='min rows in table')
    parser.add_argument('--max_row', type=int, default=16, help='max rows in table')
    parser.add_argument('--min_col', type=int, default=2, help='min cols in table')
    parser.add_argument('--max_col', type=int, default=2, help='max cols in table')
    # row and col span
    parser.add_argument('--max_span_row_count', type=int, default=0, help='max span rows')
    parser.add_argument('--max_span_col_count', type=int, default=0, help='max span cols')
    parser.add_argument('--max_span_value', type=int, default=0, help='max value in rowspan and colspan')
    # txts lens
    ...
    # windows size
    parser.add_argument('--brower_width', type=int, default=3020, help='width of brower')
    parser.add_argument('--brower_height', type=int, default=3540, help='height of brower')
